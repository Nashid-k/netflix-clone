    ...
    <div className="hero-bg relative">
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2 ">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Watch on Smart TVs, PlayStation, Xbox, Chomecast, Apple TV,
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2 ">
              ...
              <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
                ...
                <div className="flex justify-between items-center w-full">
                  <div className="flex flex-col gap-0">
                    ...
                    <span className="text-sm text-blue-500 ">Donwload</span>
                  </div>
          ...
          <div className="flex-1 md:text-left sm:text-center">
          ...
          <div className="flex-1 relative">
            <img src="/kids.png " alt="Enjoy on your TV"  className="mt-4"/>
             ...
             <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl">Send kids on adventures with their favorite characters in a space made just for them-free with your memborship.</p>
             </div>
        </div>
